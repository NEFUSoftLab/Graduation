			...
			<aside class="col-md-2 col-sm-2 col-xs-12">
				<ul id="accordion" class="accordion">
					<li>
						...
						<ul class="submenu">
							<li><a href="admin-getAllTeacherBySize.action" data-trigger="ajax" data-target="#section-container">教师信息</a></li>
							<li><a href="admin-addTeacher.action" data-trigger="ajax" data-target="#section-container">添加教师</a></li>
						</ul>
					</li>
					<li>
